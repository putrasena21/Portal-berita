...
$sql = "SELECT id_kategori, kategori 
FROM kategori 
LIMIT ".$offset.",". $limit;
$qry = $koneksi->query($sql) or die ($mysqli->error);
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-3">
								<form method="POST" action="kategori-aksi.php?act=tambah">
									<div class="form-group">
										<label>Tambah Kategori</label>
										<input class="form-control input-sm" name="kategori" type="text"
											placeholder="Tambah Kategori"></input>
									</div>
									<div class="form-group">
										<button class="btn btn-sm btn-default"><i class="fa fa-plus-circle"></i>
											Tambah</button>
									</div>
								</form>
							</div>
							...
							<table class="table table-hover table-bordered">
								<thead>
									<tr>
										<th width="10%" style="text-align: right" hidden>ID Kategori</th>
								...
								<tbody>
									...
									?>
									<tr>
										<td style="text-align: center" hidden><?php echo $kat_list['id_kategori']; ?>
										</td>
										<td style="text-align: center"><?php echo $no++; ?></th>
										<td style="text-align: center"><?php echo $kat_list['kategori'] ?></td>
										<td style="text-align: center">
											<?php if ($kat_list['kategori']!='Uncategorized') { ?>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');"
												href="kategori-aksi.php?act=hapus&amp;id=<?=$kat_list['id_kategori']?>"
						...
						<div class="col-md-12">
							<ul class="pagination">
								...
								<li>
									<a href="<?php echo "kategori-data.php?p=".($noPage-1);?>">
