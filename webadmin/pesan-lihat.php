		...
		<div class="col-lg-10 main-content">
			<div class="panel panel-default">
				<div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="pesan-data.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
                            <a href="pesan-hapus.php?id=<?=$pesan['pesan_id']?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus Pesan</a>
                        </div>
                    </div>
				</div>
			</div>
