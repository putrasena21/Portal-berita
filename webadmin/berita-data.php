...
$sql = "SELECT berita.id_berita, berita.judul, admin.id_admin, berita.gambar, berita.tgl_posting, admin.nama_admin, kategori.kategori
FROM berita
		...
		<div class="col-lg-10 main-content">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<a href="berita-tambah.php" class="btn btn-sm btn-primary">
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<img src="../images/<?php echo $news_list['gambar']; ?>" height="75"
												width="75">
										</td>
										<td><?php echo $news_list['kategori']; ?></td>
										<td><?php echo $news_list['tgl_posting']; ?></td>
										<td><?php echo $news_list['nama_admin']; ?></td>
										<td align="center">
											<?php if ($news_list['id_admin'] == $_SESSION['id_admin'] or $_SESSION['level']=='admin') { ?>
											<a class="btn btn-sm btn-primary" target="_blank"
												href="<?php echo $base_url.'detail.php?id='.$news_list['id_berita']; ?>">
												<i class="fa fa-eye"></i>
											</a>
											<a href="berita-edit.php?id=<?=$news_list['id_berita']?>"
												class="btn btn-sm btn-success">
												<i class="fa fa-edit"></i>
											</a>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');"
												href="berita-hapus.php?id=<?=$news_list['id_berita']?>"
