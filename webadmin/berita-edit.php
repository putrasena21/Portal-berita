...
if (isset($_POST['btn_edit'])) {
    ...
    if (count($message)==0) {
    	...
    	echo "<script>alert('Data Berhasil Diperbarui'); window.location = 'berita-data.php'</script>";
    }
						...
						<div class="col-md-12">
							<form action="" method="post" enctype="multipart/form-data">
								<div class="col-sm-8">
									...
									<div class="form-group">
										<textarea class="form-control input-sm" name="teks_berita" id="summernote" rows="15"><?php echo $var_teksberita; ?></textarea>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
