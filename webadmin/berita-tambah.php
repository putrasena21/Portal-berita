...
if (isset($_POST['btn_publish'])) {
    ...
    $file_max_weight = 2097152; //batas maksimum ukuran file
    ...
    if (empty($file_name_gambar)) {
        ...
        if ($file_weight_gambar >= $file_max_weight || $file_weight_gambar == 0){
    ...
    if (count($message)==0) {
    	...
    	echo "<script>alert('Data Berhasil Ditambah'); window.location = 'berita-data.php'</script>";
    }
								...
								<div class="col-sm-8">
									<div class="form-group">
										<input type="text" class="form-control" name="judul" placeholder="Judul Berita"
											value="<?php echo $var_judul; ?>" required>
									</div>
									<div class="form-group">
										<textarea class="form-control input-sm" name="teks_berita" id="summernote"
											rows="15"><?php echo $var_teksberita; ?></textarea>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<input type="date" class="form-control input-sm" name="tgl_posting"
									...
									<div class="form-group">
										...
										<label class="text-muted">Ukuran gambar maks. 2 MB dengan type: jpg, png,
											gif</label>
										<img id="image" width="100%" height="250" alt="Preview Gambar"
											style="align-items:center; justify-content:center">
									</div>
								</div>
								<div class="col-sm-12">
									<a href="berita-data.php" class="btn btn-danger btn-sm">
