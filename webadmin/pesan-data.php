...
LIMIT ".$offset.",". $limit;
$qry = $koneksi->query($sql) or die ("Error retrieving data: ".$koneksi->error);

$sql_rec = "SELECT pesan.pesan_id FROM pesan";

$total_rec = $koneksi->query($sql_rec) or die ("Error retrieving number:".$koneksi->error);
					...
					<div class="row">
							...
							<table class="table table-hover">
								...
								<?php } else { ?>
									...
									<tr>
										...
										<td align="center">
											<a href="pesan-lihat.php?id=<?=$pesan['pesan_id']?>" class="btn btn-sm btn-primary">
												<i class="fa fa-eye"></i>
											</a>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="pesan-hapus.php?id=<?=$pesan['pesan_id']?>" class="btn btn-danger btn-sm">
						...
						<div class="col-md-12">
							...
							<?php if ($noPage > 1) { ?>
								...
								<li>
									<a href="<?php echo "pesan-data.php?p=".($noPage-1);?>">
