...
$sqlAuthor = "SELECT nama_admin, foto, deskripsi FROM admin WHERE id_admin='".$koneksi->real_escape_string($_GET['id'])."'";

$qryAuthor = $koneksi->query($sqlAuthor) or die($koneksi->error);
...
if ($jumlah > 0) {
	...
	WHERE admin.id_admin = '".$koneksi->real_escape_string($_GET['id'])."'
	ORDER BY
	berita.tgl_posting DESC
	LIMIT ".$offset.",". $limit;

	$sql_rec = "SELECT id_berita FROM berita WHERE id_admin = '".$koneksi->real_escape_string($_GET['id'])."'";
				...
				<div class="panel-body main">
					<div class="col-md-8">
						<div class="author">
							...
							<div class="author-data">
								<p><span class="author-name"><?php echo $author['nama_admin']; ?></span></p>
								<p class="author-desc text-muted"><?php echo $author['deskripsi']; ?></p>
							</div>
						</div>
						<h4>Berita yang diposting oleh "<strong><?php echo $author['nama_admin']; ?></strong>"</h4>
						...
						<div class="post">
							...
							<div class="row post-meta">
								<div class="col-sm-3">
									<i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;<?php echo $author['nama_admin']; ?>
								</div>
								<div class="col-sm-3">
					...
					<div class="col-md-12">
						<ul class="pagination">
							...
							<li>
								<a href="<?php echo $base_url."penulis.php?id=".$_GET['id']."&amp;p=".($noPage-1);?>">
