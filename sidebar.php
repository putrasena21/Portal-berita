						...
						<div class="sidebar-item">
							...
							<?php while ($populer_list = $list_populer->fetch_array()) { ?>
								<li>
									...
									<p>Oleh: <a href="<?php echo $base_url."penulis.php?id=".$populer_list['id_admin']; ?>"><?php echo $populer_list['nama_admin']; ?></a>&nbsp;&nbsp;&ndash;&nbsp;&nbsp;<?php echo $populer_list['tgl_posting']; ?></p>
						...
						<div class="sidebar-item">
							...
							<?php while ($terkini_list = $list_terkini->fetch_array()) { ?>
								<li>
									...
									<p>Oleh: <a href="<?php echo $base_url."penulis.php?id=".$terkini_list['id_admin']; ?>"><?php echo $terkini_list['nama_admin']; ?></a>&nbsp;&nbsp;&ndash;&nbsp;&nbsp;<?php echo $terkini_list['tgl_posting']; ?></p>
									<a href="<?php echo $base_url."detail.php?id=".$terkini_list['id_berita']."&amp;judul=".strtolower(str_replace(" ", "-", $terkini_list['judul'])); ?>">
