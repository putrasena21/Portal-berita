...
$qryHal = $koneksi->query($sqlHal) or die($koneksi->error);
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav headline-container">
              ...
              <li>
                <ul id="headlines" class="headlines">
                  ...
                  <li>
                    <a
                      href="<?php echo $base_url."detail.php?id=".$breaking_news['id_berita']."&amp;judul=".strtolower(str_replace(" ", "-", $breaking_news['judul'])); ?>">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              ?>
              <li class="active"><a href="<?php echo $base_url.$hal['link']; ?>"><?php echo $hal['nm_halaman']; ?></a>
              </li>
              <?php
                  } else {
                    ?>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="index.php" class="hvr-sweep-to-top"><i
                ...
                <li class="active">
                  <a class="hvr-sweep-to-top"
                    href="<?php echo $base_url."kategori.php?id=".$kat_menu['id_kategori']."&amp;kat=".strtolower($kat_menu['kategori']); ?>">
