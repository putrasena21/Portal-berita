...
$query = $koneksi->real_escape_string($_GET['q']);
...
WHERE
berita.judul LIKE '%".$koneksi->real_escape_string($query)."%' OR
kategori.kategori LIKE '%".$koneksi->real_escape_string($query)."%'";
						...
						<div class="post">
							...
							<div class="row post-meta">
								<div class="col-sm-3">
									...
									<a href="<?php echo $base_url."penulis.php?id=".$post_search['id_admin']; ?>">
										<?php echo $post_search['nama_admin']; ?>
									</a>
								</div>
								<div class="col-sm-3">
