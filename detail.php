...
$qryDetail = $koneksi->query($sqlDetail) or die("Error retreiving detail:".$koneksi->error);
						...
						<div class="post-detail">
							...
							<div class="row post-meta">
								<div class="col-sm-3">
									...
									<a <a href="<?php echo $base_url.'penulis.php?id='.$detail['id_admin']; ?>"><?php echo $detail['nama_admin']; ?></a>
								</div>
								<div class="col-sm-3">
